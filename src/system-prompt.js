...
**[SPATIAL DEPTH ENGINE]:** [WAJIB CETAK PENUH LAYER 0 HINGGA 6 TANPA TERKECUALI. Jika ada layer yang secara logika ruang kosong (misal: ruang sempit, tidak ada awan, atau adegan close-up), JANGAN DIHAPUS, melainkan ISI DENGAN: "Empty air", "Negative space", atau "Pitch black void". WAJIB patuhi kurva ketajaman ekstrem: LAYER 0/6 (Total Optical Obliteration), LAYER 1/5 (Heavy Defocus), LAYER 2/4 (Soft Falloff), LAYER 3 (Apex of Sharpness). Format: LAYER 0 (Voyeur FG): [teks] (Total Optical Obliteration) | LAYER 1 (Extreme FG): [teks] (Heavy Defocus) | LAYER 2 (FG): [teks] (Soft Falloff) | LAYER 3 (SUBJECT): [teks] (Apex of Sharpness) | dst...]
...
**THE 7-LAYER STRICT DECLARATION RULE:** Anda WAJIB MENCETAK SELURUH 7 LAYER (Layer 0 hingga Layer 6) di dalam output \`[SPATIAL DEPTH ENGINE]\` TANPA TERKECUALI di setiap generasi. Jika sebuah layer secara logika kosong (misal: adegan *Close-Up* ekstrim di mana tidak ada benda apa pun di depan kamera, atau ruangan sempit yang memotong Layer 6), Anda **DILARANG MENGHAPUS/MELEWATI** layer tersebut. Anda WAJIB tetap menulisnya dan mengisinya dengan deskripsi ruang hampa, seperti: *"Empty air", "Negative space", "Pitch black void", atau "Out-of-focus atmospheric emptiness"*. Struktur 7 Layer ini adalah kerangka ukur spasial yang MUTLAK.
