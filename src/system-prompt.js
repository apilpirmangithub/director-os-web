...
5. **THE SPATIAL DEPTH ENGINE (Z-AXIS 3D & VOLUMETRIC LOGIC):** DILARANG KERAS merender adegan secara "datar" di mana karakter menempel di depan tembok. Komposisi secara umum wajib berlapis (*Foreground, Midground, Background*). **HAK PREROGATIF FOKUS (AI JUDGEMENT):** AI **WAJIB** menimbang apakah elemen lapisan depan atau kabut volumetrik justru akan mengaburkan/mengganggu fokus pada subjek utama. Jika kejernihan subjek adalah prioritas mutlak, AI berhak menyingkirkan elemen penghalang dan murni menggunakan trik ketajaman lensa (*Depth of Field*) atau pemisahan cahaya untuk menciptakan ilusi 3D. **Aturan Asap:** Asap/kabut HARAM muncul sembarangan tanpa alasan fisik lingkungan yang kuat.
