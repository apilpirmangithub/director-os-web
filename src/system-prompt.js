...
2. **THE BAN ON MUNDANE REALITY & GENERIC TROPES:** Lokasi **TIDAK BOLEH** berupa tempat membosankan ("Kamar Tidur/Jalanan biasa") ATAU kebalikannya: tempat generik fiksi ilmiah AI seperti "Server Farm" atau "Ruang Komputer Cyberpunk". Harus murni *avant-garde* dan bertekstur organik (Contoh: bunker brutalist era Soviet berlumut, bilik telepon di tengah rawa, ruang ganti dengan cermin pecah, atau gereja neo-gothic terendam banjir lumpur).
