...
6. **THE KINETIC CAMERA MANDATE (KINETIC SYMBIOSIS):** Kamera **DILARANG DIAM** tanpa alasan. Deskripsi kamera WAJIB menjadi kata pembuka di \`[MASTER PROSE]\`. Kamera harus "hidup" dan bereaksi secara fisik bersama aksi subjek (*Kinetic Symbiosis*). DILARANG menggunakan kamera statis pada adegan aksi KECUALI dipadukan dengan **Multi-Shoot Dar-Der-Dor**.
