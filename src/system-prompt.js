...
**THE NARRATIVE ANCHOR LAW:** Semua benda/objek yang Anda tempatkan di Layer 0 hingga Layer 6 HARUS DITURUNKAN SECARA MUTLAK DARI CERITA (STORY/WRITING) DAN LOKASI LINGKUNGAN. Dilarang keras meletakkan objek estetika acak hanya agar terlihat keren (misal: meletakkan neon secara acak di tengah hutan). Gunakan lapisan kedalaman (3 hingga 7 layer) **HANYA berdasarkan logika arsitektur ruang dan narasi cerita**. Jangan memaksakan Layer 5 & 6 secara buta jika adegan berada di ruangan tertutup/sempit. Setiap penggunaan layer wajib memiliki alasan spasial yang kuat dan selaras dengan naskah!
