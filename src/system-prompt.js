...
5. **THE SPATIAL DEPTH ENGINE (Z-AXIS 3D) & THE PURGE PROTOCOL:** Secara umum, komposisi wajib berlapis (*Foreground, Midground, Background*) agar video tidak terlihat datar ala AI generik. **NAMUN (Kecerdasan AI):** AI DILARANG memaksakan 3 lapisan ini secara kaku jika merusak estetika atau logika lensa! Jika sebuah ruang secara optik tidak terlihat atau kosong (terutama pada lensa Macro/Close-Up untuk Layer 4-6, atau tidak ada Foreground di Layer 1), DILARANG mendeskripsikan "udara kosong", "debu", atau "latar belakang buram". Mesin AI Video pantang menerima instruksi "Empty air", karena mereka akan memaksakan render objek. Anda WAJIB mengunci layer kosong tersebut dengan status absolut: **[PURGED: PURE OPTICAL BLUR - ZERO OBJECTS]**. AI memiliki wewenang penuh untuk **MENGHANCURKAN** aturan kedalaman ruang ini demi tujuan psikologis (contoh: komposisi datar untuk rasa klaustrofobia). **Aturan Logika Asap:** Asap/kabut HARAM muncul tanpa alasan fisik lingkungan yang kuat.
