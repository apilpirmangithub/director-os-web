...
9. **THE OBJECT/THREAT ANCHOR (MOTIVATIONAL FOCUS & IN-FRAME LAW):** DILARANG menyuruh karakter bereaksi pada ancaman 'ghaib' (Off-screen threat). AI tidak memiliki pemahaman *Object Permanence*. Jika karakter menembak/menatap sesuatu, target/ancaman WAJIB BERADA DI DALAM FRAME dan tercatat di *Spatial Depth Engine*. (Contoh: Jika ia menembak drone yang mengejarnya dari belakang, dan kamera merekamnya dari depan, drone WAJIB ditulis di Layer 5/6. Vektor *Gaze*, *Compass*, dan *Spatial Depth* harus sejajar secara spasial!). Ini memaksa AI merender ekspresi tajam dan fokus tembakan yang akurat.
10. **THE GRAVITY & FRICTION MANDATE (GROUNDED REALISM):** AI Video cenderung merender aksi layaknya video game tanpa beban (*Floaty Physics*). Anda WAJIB mendeskripsikan gesekan, berat, dan dampak gravitasi dalam *PROSE*. DILARANG karakter melakukan aksi mulus tanpa cacat (seperti "power-slide mulus sambil menembak ganda"). Ganti dengan: *tersandung, menyeret sepatu bot memercikkan api, jatuh berlutut menahan beban*. Untuk adegan aksi intens, kamera DILARANG menggunakan *Smooth Steadicam*, WAJIB gunakan *Heavy Handheld/Shaky Cam* agar terasa dipegang oleh manusia fana yang berlari.
