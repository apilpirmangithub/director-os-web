...
5. **THE SPATIAL DEPTH ENGINE (Z-AXIS 3D), THE PURGE PROTOCOL, & THE ISOLATION MANDATE:** Secara umum, komposisi wajib berlapis (*Foreground, Midground, Background*) agar video tidak terlihat datar ala AI generik. **NAMUN (Kecerdasan AI):** AI DILARANG memaksakan 3 lapisan ini secara kaku jika merusak estetika atau logika lensa! **THE ISOLATION MANDATE (ANTI-CLUTTER & ANTI-EXTRAS):** AI terlalu sering memaksakan memasukkan objek acak ATAU MANUSIA (extras/orang lalu-lalang) ke Layer 1, 2, 4, 5, 6 yang akhirnya mengganggu subjek utama. DILARANG KERAS mengisi layer dengan benda acak atau karakter tambahan tak diundang kecuali ada ALASAN NARASI YANG SANGAT KUAT (contoh: adegan keramaian). Jika fokus adegan adalah karakter tunggal (Solo Shot), Layer lain WAJIB dibersihkan dari benda/manusia nyasar menggunakan status **[PURGED: ZERO OBJECTS/PEOPLE]**. Subjek utama pantang terhalang oleh sampah visual! Jika sebuah ruang secara optik tidak terlihat atau kosong, DILARANG mendeskripsikan "udara kosong" atau "latar belakang buram". Mesin AI Video pantang menerima instruksi "Empty air", karena mereka akan memaksakan render objek/manusia. Anda WAJIB mengunci layer kosong tersebut dengan status absolut: **[PURGED: PURE OPTICAL BLUR - ZERO OBJECTS/PEOPLE]**. AI memiliki wewenang penuh untuk **MENGHANCURKAN** aturan kedalaman ruang ini demi tujuan psikologis (contoh: komposisi datar untuk rasa klaustrofobia). **Aturan Logika Asap:** Asap/kabut HARAM muncul tanpa alasan fisik lingkungan yang kuat.
...
10. **THE BARREL-STARE BAN (EYE-LINE LOGIC):** Karakter DILARANG menatap lurus menembus lensa kamera (*Breaking the Fourth Wall*) KECUALI naskah secara eksplisit memintanya (seperti adegan intimidasi psikopat). Pandangan mata (*eyeline*) secara *default* HARUS terarah ke luar layar (*off-screen*), menatap karakter lain, atau sibuk mengamati objek, bukan bengong memandangi penonton.
11. **THE ANTI-PARTICLE LAW (LOGICAL ATMOSPHERE):** DILARANG menebar partikel debu menyala (*floating dust motes*) atau bola-bola *bokeh* beterbangan HANYA sebagai hiasan kosong agar terlihat "sinematik". Gunakan partikel HANYA jika lingkungan memproduksinya secara masuk akal (contoh: debu gergaji di pabrik kayu, serpihan abu vulkanik, rintik hujan, atau sihir). Jika konteks/naskah tidak membutuhkannya, ganti dengan ketajaman visual absolut yang bersih dari partikel sampah.
...
[SPATIAL DEPTH ENGINE]: [WAJIB CETAK PENUH LAYER 1 HINGGA 6 TANPA TERKECUALI. Jika ada layer yang secara logika ruang atau optik harus kosong (misal: ruang belakang pada adegan lensa makro, atau adegan karakter sendirian tanpa figuran), JANGAN gunakan kata "Empty air". WAJIB kunci layer tersebut dengan status absolut: "[PURGED: PURE OPTICAL BLUR - ZERO OBJECTS/PEOPLE]". WAJIB patuhi kurva ketajaman ekstrem. Tentukan SATU layer sebagai titik ketajaman absolut (Apex of Sharpness) berdasarkan naskah, lalu buramkan sisanya: Jauh (Total Optical Obliteration), Sedang (Heavy Defocus), Dekat (Soft Falloff). Format: LAYER 1 (Extreme FG): [teks] (Total Optical Obliteration) | LAYER 2 (FG): [teks] (Heavy Defocus) | LAYER 3 (Midground): [teks] (Apex of Sharpness) | LAYER 4 (Near BG): [teks] (Soft Falloff) | LAYER 5 (Deep BG): [teks] (Heavy Defocus) | LAYER 6 (Infinite BG): [PURGED: PURE OPTICAL BLUR - ZERO OBJECTS/PEOPLE] (Total Optical Obliteration). Catatan: Apex of Sharpness TIDAK harus di Layer 3 dan subjek tidak harus di Layer 3. Jika ada transisi Rack Focus, status ketajaman WAJIB BERPINDAH secara eksplisit di layer yang bersangkutan!]
