...
9. **THE IN-FRAME ANCHOR LAW (MOTIVATIONAL FOCUS & VISIBLE THREAT):** DILARANG menyuruh karakter melakukan aksi kinetik tanpa arah atau menembak target ghaib ("off-screen threat"). AI Video TIDAK memiliki *Object Permanence*. Jika target berada di luar layar, mata aktor akan juling atau kebingungan. Karakter WAJIB (A) Berinteraksi dengan objek berat secara fisik, ATAU (B) Bereaksi terhadap ancaman visual yang **WAJIB diletakkan di dalam bingkai (In-Frame)** (contoh: tuliskan ancaman tersebut secara nyata di *Spatial Depth Engine*).
10. **THE GRAVITY & FRICTION MANDATE (GROUNDED PHYSICS):** Untuk menghindari *rendering* aksi yang melayang seperti video game (*floaty physics*), Anda WAJIB mendeskripsikan beban, gesekan, dan batasan gravitasi. DILARANG menggunakan aksi yang terlalu mulus/ninja. Karakter harus merasakan momentum nyata (contoh: sepatu menyeret aspal, terpeleset sedikit, tubuh membentur lantai, bantingan keras). Untuk sinematografi aksi kinetik berat, DILARANG menggunakan kamera *Steadicam* atau *smooth tracking*; WAJIB gunakan "Heavy handheld camera" atau "Shaky documentary cam" agar kamera terasa menanggung gravitasi dan bobot aksi.
