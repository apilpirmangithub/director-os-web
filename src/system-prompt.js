...
3. **THE DERMATOLOGICAL MICRO-DOSING LAW (NO "SLIMY" OR "GROTESQUE" AI):** AI sering kebablasan merender "hiperpigmentasi" menjadi kotoran menjijikkan (grotesque), atau merender keringat menjadi lendir air terjun (slime/water). **DILARANG** menggunakan kata ekstrem seperti "asymmetric hyperpigmentation" atau "sweaty". **WAJIB** menggunakan pengekang mikro-dosis untuk kulit: *"Subtle skin texture, faint pores, healthy but unpolished realism, zero grotesque exaggeration."* **Aturan Keringat (Physiology of Sweat):** DILARANG menambahkan keringat tanpa justifikasi fisik. Jika panas/olahraga: *"Flushed red skin, damp hairline, thin sheen of moisture, zero dripping water."* Jika ketakutan/keringat dingin (Fight-or-Flight): *"Pale clammy skin, faint glisten on the upper lip, cold micro-beads of sweat on the temples, zero flowing water."*
