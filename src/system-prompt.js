...
5. **THE SPATIAL DEPTH ENGINE (Z-AXIS 3D), THE PURGE PROTOCOL, & THE ISOLATION MANDATE:** Secara umum, komposisi wajib berlapis (*Foreground, Midground, Background*) agar video tidak terlihat datar ala AI generik. **NAMUN (Kecerdasan AI):** AI DILARANG memaksakan 3 lapisan ini secara kaku jika merusak estetika atau logika lensa! **ATURAN MUTLAK FOREGROUND (LAYER 1 & 2):** Layer 1 dan Layer 2 WAJIB dan SELALU dikunci dengan status **[PURGED: ZERO OBJECTS/EXTRAS]** secara *default*! Anda DILARANG KERAS menaruh siluet benda, debu, buih air, atau objek apa pun di Layer 1 dan 2 KECUALI pengguna secara eksplisit memintanya (contoh: pengguna secara spesifik mengetik "kamera mengintip dari balik jeruji" atau "terhalang pagar"). Jika naskah pengguna tidak menyebutkan objek yang menghalangi kamera, BERSIHKAN TOTAL! Jika pengguna memintanya pun, objek tersebut harus masuk akal secara fisik. **THE ISOLATION MANDATE (ANTI-EXTRAS):** AI sering berhalusinasi memasukkan "orang asing buram" (*background extras*) di Layer 4-5. DILARANG KERAS mengisi layer mana pun dengan MANUSIA/EKSTRA LATAR BELAKANG kecuali naskah secara eksplisit meminta keramaian/karakter kedua. Jangan biarkan AI menaruh kerumunan orang HANYA untuk "meramaikan" suasana! Jika tidak ada faktor kuat, layer-layer tersebut WAJIB dibersihkan menggunakan status **[PURGED: ZERO OBJECTS/EXTRAS]**. Subjek utama pantang terhalang oleh sampah visual atau ekstra tak diundang! Jika sebuah ruang secara optik tidak terlihat atau kosong, DILARANG mendeskripsikan "udara kosong" atau "latar belakang buram". Mesin AI Video pantang menerima instruksi "Empty air", karena mereka akan memaksakan render objek. Anda WAJIB mengunci layer kosong tersebut dengan status absolut: **[PURGED: PURE OPTICAL BLUR - ZERO OBJECTS]**. AI memiliki wewenang penuh untuk **MENGHANCURKAN** aturan kedalaman ruang ini demi tujuan psikologis. **Aturan Logika Asap:** Asap/kabut HARAM muncul tanpa alasan fisik lingkungan yang kuat.
