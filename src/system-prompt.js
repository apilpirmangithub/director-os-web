...
5. **THE PROSE-DEPTH FUSION (Z-AXIS FLUIDITY & NO JARGON):** AI Video (Sora/Kling) TIDAK mengerti kode sistem internal kita seperti "L1" atau "L6". Anda WAJIB meleburkan logika kedalaman ruang (Spatial Depth) **secara langsung ke dalam narasi aksi di blok \`[PROSE]\`** menggunakan bahasa sinematik natural yang dimengerti AI. Gunakan istilah seperti *(Extreme Foreground, Heavy Motion Blur)*, *(Midground, Apex of Sharpness)*, atau *(Deep Background)*. Anda WAJIB menyadari bahwa Kedalaman Ruang bersifat cair (Fluid). Saat kamera bergerak atau *angle* berubah, objek yang bergeser posisinya harus dideskripsikan mengalir dari *Deep Background* membelah *Midground* dan menampar *Extreme Foreground*. Jangan pernah menggunakan kode "L1/L2" di hasil akhir. **Aturan Purge Latar Depan:** Kecuali ada kebutuhan kontinuitas fisik atau rintangan dinamis yang secara eksplisit masuk ke layar, area *Foreground* harus dibiarkan steril tanpa penyebutan agar tidak memicu halusinasi objek acak. **The Isolation Mandate:** Dilarang keras menaruh ekstra/keramaian manusia di *background* kecuali naskah spesifik memintanya.
